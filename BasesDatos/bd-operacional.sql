...
INSERT INTO public.alumno (nif, nombre, apellidos, fecha_nacimiento, direccion, email, estado) VALUES ('74924381B', 'Manuel', 'Ameal', '2000-01-05', 'Torre de Abaixo numero 2 A Coruna', 'manuel.ameal@correo.com', 'I');
...
INSERT INTO public.practica (cod_practica, fecha_practica, precio, tipo_pago, nif_alumno, nif_profesor, matricula_vehiculo, tiempo) VALUES ('1', '2016-02-10', 21.50, 'Metalico', '84214356X', '74924381B', '1343DFF', 45);
INSERT INTO public.practica (cod_practica, fecha_practica, precio, tipo_pago, nif_alumno, nif_profesor, matricula_vehiculo, tiempo) VALUES ('2', '2016-02-11', 48.00, 'Metalico', '84214356X', '74924381B', '1343DFF', 90);
INSERT INTO public.practica (cod_practica, fecha_practica, precio, tipo_pago, nif_alumno, nif_profesor, matricula_vehiculo, tiempo) VALUES ('3', '2016-02-12', 30.00, 'Metalico', '84214356X', '74924381B', '1343DFF', 60);
INSERT INTO public.practica (cod_practica, fecha_practica, precio, tipo_pago, nif_alumno, nif_profesor, matricula_vehiculo, tiempo) VALUES ('4', '2019-01-16', 50.00, 'Tarjeta', '45984511U', '74924381B', '7654FGS', 95);
INSERT INTO public.practica (cod_practica, fecha_practica, precio, tipo_pago, nif_alumno, nif_profesor, matricula_vehiculo, tiempo) VALUES ('5', '2021-03-12', 66.95, 'Metalico', '92342123O', '23342942N', '2643LPS', 120);
